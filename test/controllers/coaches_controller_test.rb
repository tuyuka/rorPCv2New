...
class CoachesControllerTest < ActionController::TestCase
  ...
  test "should create coach" do
    assert_difference('Coach.count') do
      post :create, coach: { assigned_id: @coach.assigned_id, comments: @coach.comments, email: @coach.email, first_name: @coach.first_name, last_name: @coach.last_name, site: @coach.site }
    end
  ...
  test "should update coach" do
    patch :update, id: @coach, coach: { assigned_id: @coach.assigned_id, comments: @coach.comments, email: @coach.email, first_name: @coach.first_name, last_name: @coach.last_name, site: @coach.site }
    assert_redirected_to coach_path(assigns(:coach))
  end
